...
const TrustHero: React.FC<TrustHeroProps> = ({ userId, goldBalance, energyBalance, mousePosition }) => {
  ...
  return (
    <motion.div
      ...
      aria-label="Private Energy Trust Hero Section"
    >
      ...
      <div className="relative space-y-6">
        ...
        {userId && (
          <p className="text-gray-300 text-center font-inter">
            Your JEWELS: <span className="font-bold text-rose-400">{goldBalance} JEWELS</span> | Energy: <span className="font-bold text-rose-400">${energyBalance.toFixed(2)}</span>
          </p>
        )}
