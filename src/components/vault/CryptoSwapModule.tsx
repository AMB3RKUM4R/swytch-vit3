...
const CryptoSwapModule: FC<CryptoSwapModuleProps> = ({ userId, setShowMessage, setActiveModal, isConnected }) => {
  ...
  const handleInitiateDeposit = async () => {
    ...
    if (isNaN(parseFloat(fromAmount)) || parseFloat(fromAmount) <= 0) {
      ...
      setShowMessage('⚠️ Please enter a valid amount to deposit.');
      return;
    }
