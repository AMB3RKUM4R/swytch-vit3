      ...
      >
        <div className="space-y-6">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto font-inter">
            Become a PET and harness your Energy to shape a decentralized future. Your journey to sovereignty starts now.
          </p>
          <motion.button
