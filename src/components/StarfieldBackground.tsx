...
const DynamicStarfield = () => {
    ...
    return (
        <>
            ...
            <Stars ref={starsRef3} radius={60} depth={20} count={1000} factor={5} saturation={1} fade speed={3} />
            <Stars ref={starsRef4} radius={120} depth={60} count={2000} factor={3} saturation={1} fade speed={0.5}  />
        </>
    );
};
        ...
        <div className="fixed inset-0 z-0">
            <Canvas camera={{ position: [0, 0, 1] }}>
                ...
                <EffectComposer multisampling={0}>
                    <DynamicStarfield />
                    <Bloom intensity={2} luminanceThreshold={0.5} luminanceSmoothing={0.2} /> 
                    <ChromaticAberration radialModulation={true} modulationOffset={1.5}  />
                </EffectComposer>
            </Canvas>
        </div>
    );
