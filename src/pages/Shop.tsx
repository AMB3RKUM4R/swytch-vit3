    ...
    <SwytchErrorBoundary setShowMessage={function (_value: SetStateAction<string>): void {
      ...
      >
        ...
        <motion.div className="relative z-10 max-w-6xl mx-auto py-16 px-6 sm:px-8 lg:px-16">
          ...
          <motion.div variants={sectionVariants}>
            <FeaturedNFTs isPETMember={false} isPending={false} setActiveModal={function (_value: SetStateAction<string | null>): void {
              throw new Error('Function not implemented.');
            } } />
          </motion.div>
          <motion.div variants={sectionVariants}>
          ...
          <motion.div variants={sectionVariants}>
            <MembershipUpgrade
              ...
              setShowMessage={setShowMessage} userId={null} setIsPETMember={function (_value: SetStateAction<boolean>): void {
                throw new Error('Function not implemented.');
              } }            />
          </motion.div>
          <motion.div variants={sectionVariants}>
